...
# ------------------------- Config -------------------------
# 1.1 mf4 location
mf4_folder_path = r'D:\DataSet\Mf4RawFile'    # [ Config ]: The folder address where mf4 is located
...
# 1.3 Store location
Store_path = r'D:\DataSet\TimeSliceData' # if Store_path = [], the data will be stored in the default path
