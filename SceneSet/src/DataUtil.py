...
def get_slot_information(mdf_resample, index):
    slot_x = [(mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P0_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P1_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P2_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P3_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P0_X_ISO8855_Rear_Axle_m._0_'])]
    slot_y = [(mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P0_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P1_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P2_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P3_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv.PS_P0_Y_ISO8855_Rear_Axle_m._0_'])]
...
def get_slot_information_CPA(mdf_resample, index):
    slot_x = [(mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P0_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P1_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P2_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P3_X_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P0_X_ISO8855_Rear_Axle_m._0_'])]
    slot_y = [(mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P0_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P1_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P2_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P3_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P0_Y_ISO8855_Rear_Axle_m._0_']),
                (mdf_resample.loc[index, 'InLy_ZF_Fusion_Parking_Slot_Set_o_obv.PS_P0_Y_ISO8855_Rear_Axle_m._0_'])]
...
def get_object_information(mdf_resample, index):
    ...
    OD_number.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Number_Of_Valid_Objects'][0])
    for i in range(0, OD_number[-1]):
        OD_x = []
        OD_y = []
        OD_confidence = []

        OD_x.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_0_X'][i])
        OD_x.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_1_X'][i])
        OD_x.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_2_X'][i])
        OD_x.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_3_X'][i])
        OD_x.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_0_X'][i])

        OD_y.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_0_Y'][i])
        OD_y.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_1_Y'][i])
        OD_y.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_2_Y'][i])
        OD_y.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_3_Y'][i])
        OD_y.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Point_0_Y'][i])

        OD_confidence.append(mdf_resample.loc[index, 'InLy_ZF_Fusion_Object_Set_o_obv.Object_Confidence'][i])

        x.append(OD_x)
        y.append(OD_y)
        confidence.append(OD_confidence)

    
    return OD_number, confidence, x, y
...
def get_slot_information_SDF(mdf_resample, index):
    slot_x = [(mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P0_X_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P1_X_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P2_X_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P3_X_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P0_X_ISO8855_Rear_Axle_m'][0])]
    slot_y = [(mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P0_Y_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P1_Y_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P2_Y_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P3_Y_ISO8855_Rear_Axle_m'][0]),
                (mdf_resample.loc[index, 'libzeekr_pecu_algo_TP_100ms_ZF_Fusion_Parking_Slot_Set_i_obv_PS_P0_Y_ISO8855_Rear_Axle_m'][0])]
    return slot_x, slot_y
...
def get_object_information_SDF(mdf_resample, index, i):
    ...
    OD_x.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_0_X'][i])
    OD_x.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_1_X'][i])
    OD_x.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_2_X'][i])
    OD_x.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_3_X'][i])
    OD_x.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_0_X'][i])

    OD_y.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_0_Y'][i])
    OD_y.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_1_Y'][i])
    OD_y.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_2_Y'][i])
    OD_y.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_3_Y'][i])
    OD_y.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Point_0_Y'][i])

    OD_Type.append(mdf_resample.loc[index, 'libzeekr_pecu_algo_Rte_Irv_SWC_APA_GLY_B1XE_HI_ZF_Fusion_Object_Set_IRV_Object_Type'][i])
    OD_Position_x.append(0.5*(OD_x[0] + OD_x[1]))
    OD_Position_y.append(0.5*(OD_y[0] + OD_y[1]))

    return OD_x, OD_y, OD_Position_x, OD_Position_y, OD_Type
...
def set_store_location(Store_path):
    ...
    if not os.path.exists(Store_path):
        ...
        store_folder_path = root_dir + r'\SceneSet\DataSet'
    ...
    print(utils.HighLightGreenMsg('Time slice of mf4 stored in pkl path : ' + store_folder_path))
...
def store_in_pkl(new_df, store_folder_path, max_file_size_M):
    ...
    # 1. Get all pkl files in the folder and sort them
    ...
    # 3. Try to write info to the last pkl and create the next pkl if exceeds storage limit
    if sum_sf.memory_usage(deep=True).sum() > max_file_size_M * 1024 * 1024:
        ...
        this_part = len(pkl_files)
        pkl_file_path = os.path.join(store_folder_path, f"mf4_time_slice_data_part{max(this_part, 1)}.pkl")
        sum_sf.to_pickle(pkl_file_path)

    return os.path.basename(pkl_file_path)

def gen_log_info(Mf4_duration_OK, PfsmState, SsmState, PrkMod, StartPose, TargetPose, ParkingSlot_type, OD_Number, FSB_Number):

    log_info = ''

    if Mf4_duration_OK == 0:
        log_info = log_info + ' - Mf4Duration err'
        return log_info
    
    if PfsmState == 0:
        log_info = log_info + ' - PfsmState err'
    if SsmState == 0:
        log_info = log_info + ' - SsmState err'
    if PrkMod == 0:
        log_info = log_info + ' - PrkMod err'

    if abs(StartPose[0] + StartPose[1] + TargetPose[0] + TargetPose[1]) < 1e-6:
        log_info = log_info + ' - StartPose or TargetPose err'
    if ParkingSlot_type == 0:
        log_info = log_info + ' - ParkingSlot_type err'
    if OD_Number[0] == 0:
        log_info = log_info + ' - OD err'
    if FSB_Number[0] == 0:
        log_info = log_info + ' - FSB err'
